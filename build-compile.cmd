...
if defined FRAMEWORK_MODULE_XINPUT (
	if "%FRAMEWORK_MODULE_XINPUT%" == "1" (
		...
		set PB_COMPILER_MODULES=%PB_COMPILER_MODULES% /CONSTANT FRAMEWORK_MODULE_XINPUT=#False
	)
) else (
	set PB_COMPILER_MODULES=%PB_COMPILER_MODULES% /CONSTANT FRAMEWORK_MODULE_XINPUT=#False
)
if defined FRAMEWORK_MODULE_SNAPPY (
	if "%FRAMEWORK_MODULE_SNAPPY%" == "1" (
		echo Using Snappy module !
		set PB_COMPILER_MODULES=%PB_COMPILER_MODULES% /CONSTANT FRAMEWORK_MODULE_SNAPPY=#True
	) else (
		set PB_COMPILER_MODULES=%PB_COMPILER_MODULES% /CONSTANT FRAMEWORK_MODULE_SNAPPY=#False
	)
) else (
	set PB_COMPILER_MODULES=%PB_COMPILER_MODULES% /CONSTANT FRAMEWORK_MODULE_SNAPPY=#False
)
if defined FRAMEWORK_MODULE_ARGUMENTS (
	if "%FRAMEWORK_MODULE_ARGUMENTS%" == "1" (
		echo Using Arguments module !
		set PB_COMPILER_MODULES=%PB_COMPILER_MODULES% /CONSTANT FRAMEWORK_MODULE_ARGUMENTS=#True
	) else (
		set PB_COMPILER_MODULES=%PB_COMPILER_MODULES% /CONSTANT FRAMEWORK_MODULE_ARGUMENTS=#False
	)
) else (
	set PB_COMPILER_MODULES=%PB_COMPILER_MODULES% /CONSTANT FRAMEWORK_MODULE_ARGUMENTS=#False
)
